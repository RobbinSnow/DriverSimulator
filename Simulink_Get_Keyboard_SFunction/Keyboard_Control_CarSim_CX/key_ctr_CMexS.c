...
#define     ang_accel           0.2       //turning left decel.
#define     ang_decel           -0.2      //turning right accel.
#define     ang_left_max        60      //max. degree of left turn
#define     ang_right_max       -60     //max. degree of right turn
#define     ang_accel_r2l       0.2     //right-turn to left-turn, turn faster(angle offset)
#define     ang_decel_l2r       -0.2     //left-turn to right-turn, turn faster(angle offset)
